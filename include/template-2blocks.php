...
<head>
	...
	<style>
		<?
		$css =file_get_contents($_home_dir.'/static/css/bootstrap.css');
		...
		<aside class='span3'>
			...
			<nav>
				<ul class='nav nav-tabs nav-stacked rd-nav-tabs'>
					<li><a class='rdajax' href='index.php?act=news'>Главная</a></li>
					<li><a class='rdajax' href='index.php?act=author'>Автор сайта</a></li>
					<li><a class='rdajax' href='index.php?act=news&amp;cat=2'>Counter-Strike</a></li>
					<li><a class='rdajax' href='index.php?act=redirect'>Переадресовщик</a></li>
					<li><a class='rdajax' href='index.php?act=ip'>Узнать IP</a></li>
					<li><a class='rdajax' href='index.php?act=support'>Связь</a></li>
					<li><a class='rdajax' href='index.php?act=fulltext&amp;id=131'>RD CMS</a></li>
					<li><a class='rdajax' href='index.php?act=news&amp;cat=4'>Инструкции</a></li>
					<li><a class='rdajax' href='index.php?act=news&amp;cat=6'>Фэнсаб</a></li>
					<li><a class='rdajax' href='index.php?act=news&amp;cat=10'>Userscripts</a></li>
				</ul>
			</nav>
		...
		<section class='span9'>
			...
			<div id='content'>
				<? if ($_ajax_enabled=="true"){ ?>
					...
					<noscript><? echo $content; ?></noscript>
				<? } else { 
					echo $content; 
				} ?>
			</div>
